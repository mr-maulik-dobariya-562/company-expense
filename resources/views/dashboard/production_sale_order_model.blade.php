        ...
        <div class="col-12">
            <div class="row justify-content-end">
                <div class="col-auto">
                    ...
                    class="btn btn-danger boqModel text-white m-1"
                    data-id="{{ $saleOrders?->id }}"
                    data-type="save"
                    data-vch_No="{{ $saleOrders?->vch_No }}">
                        BOQ
                    </a>
                </div>
            </div>
        ...
        <div class="col-sm-8 invoice-col">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <textarea name="remark" class="form-control" id="remark" cols="2"
                        rows="2">{{ $saleOrders?->remark }}</textarea>
                </div>
                <div class="col-md-5">
                    <label for="from-label">Is BOQ Status</label>
                    <select class="form-control" name="is_boq_status" id="is_boq_status">
                        <option value="Pending" {{ $saleOrders?->is_boq_status == 'Pending' ? 'selected' : '' }}>Pending
                        </option>
                        <option value="Partially Completed" {{ $saleOrders?->is_boq_status == 'Partially Completed' ? 'selected' : '' }}>Partially Completed</option>
                        <option value="Completed" {{ $saleOrders?->is_boq_status == 'Completed' ? 'selected' : '' }}>
                            Completed
                        </option>
                    </select>
                </div>
                <div class="col-md-2 mt-3">
                    <button type="submit" class="btn btn-primary mt-3 sale_order_form"
                        data-id="{{ $saleOrders?->id }}">Save</button>
                </div>
            </div>
        </div>
    </div>
